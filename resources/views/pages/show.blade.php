                ...
                <article class="post">
                    ...
                    <div class="post-content">
                        ...
                        <div class="social-share">
							<span
                                    class="social-share-title pull-left text-capitalize">By Rubel {{ $post->date}}</span>
                    ...
                    @foreach ($post->getComments() as $comment)
                        <div class="bottom-comment"><!--bottom comment-->
                            ...
                            <div class="comment-img">
                                <img class="img-circle" width="70" height="70" src="{{$comment->author->getImage()}}" alt="">
                            </div>
